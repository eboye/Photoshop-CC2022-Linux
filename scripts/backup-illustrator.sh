#!/bin/bash
# Illustrator CC 17 Backup Script for Linux
...
BACKUP_NAME="illustrator-cc17-backup-$TIMESTAMP"
...
print_header "      Illustrator CC 17 Backup Tool"
...
TEMP_DIR="$OUTPUT_DIR/.illustrator_backup_$$"
mkdir -p "$TEMP_DIR"
...
echo "  ./restore-illustrator.sh \"$BACKUP_FILE\" /path/to/restore/directory"
echo ""
echo -e "${GREEN}✓${NC} Illustrator CC 17 backup completed"
